...
export default function Navbar() {
  return <>
    <nav className="navbar navbar-expand-lg farm-nav position-sticky top-0 bg-light"  >
      ...
      <Link className="navbar-brand" to={`/`}><img src={logo} style={{Width:'100px'}}/></Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div> 
           <button className="Login-btn"> <BiSolidUser  size="1.5em" style={{marginRight:'5px'}}/>Login/SignUp</button>
          </div>
