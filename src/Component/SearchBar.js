...
// const FarmhouseSearchBar = () => {

//   return (
//     <div className="card  mt-5 mx-auto"  style={{maxWidth:'1000px' }}>
//     <form className='card-body d-flex justify-content-center' >
//       <div className="row">
//         <div className="col-md-2">
...
//         </div>
//         <div className="col-md-2">
//           <label htmlFor="checkinTime" className="form-label">Check-In Time</label><br/>
...
//         </div>
//         <div className="col-md-2">
//           <label htmlFor="checkoutTime" className="form-label">Check-Out Time</label><br/>
//           <label htmlFor="checkoutTime" className="form-label mt-2">10:00 PM</label>
//         </div>
//         <div className="col-md-2">
...
//            <br/>
//           <Link  to='/VillaList'  className="btn btn-primary btn-block" >
//             Search
//           </Link>
//         </div>
//       </div>
...
// export default FarmhouseSearchBar;
